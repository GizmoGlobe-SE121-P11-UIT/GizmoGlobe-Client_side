enum NotifyMessage {
  ...
  msg3('Failed to send verification link. Please try again.', 'Gửi liên kết xác thực thất bại. Vui lòng thử lại.'),
  msg4('Error changing password. Please try again.', 'Lỗi khi thay đổi mật khẩu. Vui lòng thử lại.'),
  ...
  msg10('Email not verified. Please verify your email.', 'Email chưa được xác thực. Vui lòng xác thực email của bạn.'),
  ;
